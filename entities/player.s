...
_PLAYER_UPDATE_SHOTS_SAVE_X:
    ...
    lh a0, 0(s3)
    lh a1, 0(s4)
    call BOSS_HANDLE_SHOT_COLLISION
...
PLAYER_CHECK_DAMAGE_COLLISION:
    ...
    call BOSS_CHECK_PLAYER_COLLISION
    bnez a0, _PLAYER_CHECK_DAMAGE_COLLISION_BODY_HIT

    call ENEMY1_CHECK_PLAYER_SHOT_COLLISION
    bnez a0, _PLAYER_CHECK_DAMAGE_COLLISION_SHOT_HIT

    call BOSS_CHECK_PLAYER_SHOT_COLLISION
    beqz a0, _PLAYER_CHECK_DAMAGE_COLLISION_DONE

_PLAYER_CHECK_DAMAGE_COLLISION_SHOT_HIT:
    mv a0, a1
